...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'naylaputrimulia@gmail.com',
    href: 'mailto:naylaputrimulia@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
    value: '+62 811 6851 184',
    href: 'tel:+628116851184',
  },
  {
    icon: MapPin,
    label: 'Lokasi',
    value: 'Banda aceh, Indonesia',
    href: 'https://www.google.com/maps/search/?api=1&query=Banda+Aceh', // Sebaiknya tambahkan link maps asli
  },
];
